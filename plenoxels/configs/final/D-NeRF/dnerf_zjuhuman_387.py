config = {
 'expname': 'zjuhuman_387_explicit',
 'logdir': './logs/syntheticdynamic',
 'device': 'cuda:0',

 'data_downsample': 1.0,
 'data_dirs': ['data/dnerf/data/zjuhuman_387'],
 'contract': False,
 'ndc': False,
 'isg': False,
 'isg_step': -1,
 ...
 'proposal_net_args_list': [
  {'num_input_coords': 4, 'num_output_coords': 8, 'resolution': [64, 64, 64, 115]},
  {'num_input_coords': 4, 'num_output_coords': 8, 'resolution': [128, 128, 128, 115]}
 ],
 ...
 # 'resolution': [64, 64, 64, 100] # original
  'resolution': [128, 128, 128, 115] # new test
 }],
}